...
from live_prices_validation.routine.connectors.teams_connector import TeamsApiClient
from live_prices_validation.routine.connectors.thot_connector import ThotApiClient
